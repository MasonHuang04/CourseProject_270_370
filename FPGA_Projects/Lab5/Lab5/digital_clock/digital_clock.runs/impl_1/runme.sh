...
HD_PWD='C:/Document HH/ECE270/Lab/Lab5/digital_clock/digital_clock.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log digital_Counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source digital_Counter.tcl -notrace
