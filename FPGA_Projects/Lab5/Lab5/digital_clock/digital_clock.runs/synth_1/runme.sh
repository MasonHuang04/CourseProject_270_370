...
HD_PWD='C:/Document HH/ECE270/Lab/Lab5/digital_clock/digital_clock.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log digital_Counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source digital_Counter.tcl
